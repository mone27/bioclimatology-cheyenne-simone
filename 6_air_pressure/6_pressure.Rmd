...
One peculiarity of air pressure that there are a lot unit commonly used.
The SI defines the Pa ($N/m^2$) as the unit for pressure. However, this is a small value so hPa (100 Pa) is more commonly used.
Another unit used, especially in barometers, is the torr or mmHg, which corresponds to
