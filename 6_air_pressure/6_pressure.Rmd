...
and the following is used for the correction of humidity virtual temperature (K)

$$T_v = T (1 + 0.608q)$$

where $q$ is the specific humidity in kg/kg units..
...
As expected, the temperature results in a higher value for the less higher place. The pressure value of the Borcken mountain was calculated using the formula mentioned in the theory background:
$$p(0) = p(z) exp({\frac{g \Delta z} {R_d T}})$$
