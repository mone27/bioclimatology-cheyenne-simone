...
According to what flux is going to be measured, some instruments can be
required as an additional equipment. The instruments can be: chambers,
lysimeter and sap flow. The following formula describes the principle on
which gas chambers are based on to measured CO2 flux in soil.
