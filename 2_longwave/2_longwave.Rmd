...
Also emissivity can be defined as (1-$\epsilon$), thus the fraction of howlongwave radiation reaching the earth surface is bounced back is explained (Bonan,2019). 
