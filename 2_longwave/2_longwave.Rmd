...
The incoming longwave radiation depends on the temperature of the sky and it is partly abosrbed by the ecosystems and partly reflected according to the following formula:
...
The ecosystem emits longwave radiation depending on the temperature 
...
rad_w %>%
  gather(key="type", value="radiation", lw_in, lw_out, sw_in, sw_out, net_rad,
         factor_key = T) %>%
ggplot() +
