...
$$R_n = (S_{incoming} - S_{outgoing}+(L_{incoming}) - L_{outgoing})$$
Also emissivity can be defined as ($1-\varepsilon$), thus the fraction of howlongwave radiation reaching the earth surface is bounced back is explained ^[Bonan, G. (2019). *Climate change and terrestrial ecosystem modeling*. Cambridge University Press.].
