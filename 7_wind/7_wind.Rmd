...
Wind can be represented as a vector in 3 dimensions.
it a vector with three compoments, this leads to complexities when handling wind data.


Wind gradient: is only valid for neutrally stratified atmosphere
