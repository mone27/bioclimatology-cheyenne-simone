...
wind_1d %>%
  ...
  gather("height", "windspeed", WS_0.5m, WS_1m, WS_2m, WS_5m, WS_10m, factor_key = T) %>% 
...
```{r}
windrose(wind$WS_10m, wind$wd, col_pal="YlGnBu")
```
...
```{r}
months <- map_df(1:13, function(n_mon){
...
```{r}
windrose(wind$WS_10m, wind$wd, wind$quarter, n_col= 2, col_pal="YlGnBu")
```
